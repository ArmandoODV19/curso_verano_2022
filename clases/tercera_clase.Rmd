...
El verbo mutate() genera una nueva variable a partir de una expresión de nuestros datos. Este verbo toma como argumento el nombre de la nueva variable de la izquierdo y del lado derecho la expresión de interés.
